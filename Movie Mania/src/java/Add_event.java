...
@WebServlet(name="Add_event", urlPatterns={"/Add_event"})     // specify urlPattern for servlet
...
public class Add_event extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String image_name = request.getParameter("event_name").replaceAll(" ", "_").toLowerCase();
            // read filename which is sent as a part
            Part p2  = request.getPart(image_name);
